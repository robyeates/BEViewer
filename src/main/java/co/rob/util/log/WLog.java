...
public class WLog implements Thread.UncaughtExceptionHandler {
  ...
  private static void log(String text) {
      ...
      //A never ending text buffer - replace with
  ...
  private static void setLogText() {
    SwingUtilities.invokeLater(() -> textArea.setText(textBuffer.toString()));
  }
   ...
   *
   *              TODO - PORT THIS TO FILE BASED LOGGING TO PRESERVE FORMAT
   */
  private static void logBytes(String text, byte[] bytes) {
  ...
  private static void logThrowable(Throwable e) {
    ...
    StackTraceElement[] stackTraceElement = e.getStackTrace();
      for (StackTraceElement traceElement : stackTraceElement) {
          textBuffer.append(traceElement);
          textBuffer.append("\n");
      }
