 ...
 */
@Deprecated(since = "1.6 - Preserved in order to JMH test with FastFeatureLineTable ")
public class FeatureLineTable {
    ...
    public void put(long startByte, int lineLength) {
        ...
        if (lineIndexInGroup == 0) {
            ...
            lineGroups.put(lineGroupNumber, activeLineGroup);
        }
    ...
    public FeatureLine get(int lineIndex) {
        ...
        return FeatureLineFactory.create(imageFile, featureFile, startByte, lineLength);
    }
