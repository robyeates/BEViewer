...
import static co.rob.BEViewer.getBEWindowLocation;
...
public class WImportScanSettings extends JDialog {
    ...
    private final JTextField settingsTF = new JTextField();
    ...
    public WImportScanSettings(String commandString) {
        setLocation(getBEWindowLocation());
        buildInterface();
        wireActions();
...
//    settingsTF.setMinimumSize(new Dimension(600, settingsTF.getPreferredSize().height));
    ...
    private void wireActions() {
        ...
        importB.addActionListener(_ -> {
            ...
            // else bad input, ignore import request
        });
