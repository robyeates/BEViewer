 ...
 * This window has no user controls and is programmatically closed.
 * Interfaces are synchronized and UI actions occur on the Swing Dispatch Thread.
 */
@WarmUpCandidate
public class WProgress {

    private static final Logger logger = LoggerFactory.getLogger(WProgress.class);
    /**
