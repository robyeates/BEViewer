...
public class BETests {
  ...
  public static void checkPreferences() {
    ...
    try {
      // save preferences
   //   BEPreferences.savePreferences(this.isVisible());
  ...
  public static void makeBookmarks(File workSettingsFile, File outputDirectory) {
   // WLog.log("test: makeBookmarks");
    ...
    boolean isSuccessful = false; //BEPreferences.importWorkSettings(workSettingsFile, false);
    if (!isSuccessful) {
